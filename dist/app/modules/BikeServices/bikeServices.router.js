...
router.get("/:serviceId", bikeServices_controller_1.BikeSRecordController.getByIdFromDB);
...
router.put("/:serviceId", bikeServices_controller_1.BikeSRecordController.updateIdFromDB);
router.delete("/:serviceId", bikeServices_controller_1.BikeSRecordController.deleteBikeSRecordFromDB);
